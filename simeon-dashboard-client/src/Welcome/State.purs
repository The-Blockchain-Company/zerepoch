...
import Capability.Simeon (class ManageSimeon, createWallet, lookupWalletDetails)
import Capability.SimeonStorage (class ManageSimeonStorage, clearAllLocalStorage, insertIntoWalletLibrary)
...
import WalletData.State (parseZerepochAppId, walletNicknameError)
...
handleAction (WalletNicknameOrIdInputAction inputFieldAction) = do
  ...
  case inputFieldAction of
    InputField.SetValue walletNicknameOrId -> do
      ...
      for_ (parseZerepochAppId walletNicknameOrId) \zerepochAppId -> do
        assign _remoteWalletDetails Loading
        handleAction $ WalletNicknameOrIdInputAction $ InputField.SetValidator $ walletNicknameOrIdError Loading
        ajaxWalletDetails <- lookupWalletDetails zerepochAppId
        assign _remoteWalletDetails $ fromEither ajaxWalletDetails
