...
import Simeon.Semantics (Slot, SlotInterval(..), Token(..))
import Simeon.Slot (slotToDateTime)
...
humanizeValue (Token "" "") value = "₳ " <> Number.format (numberFormatter 6) (toBcc value)
...
toBcc :: BigInteger -> Number
toBcc entropic = (toNumber entropic) / 1000000.0
