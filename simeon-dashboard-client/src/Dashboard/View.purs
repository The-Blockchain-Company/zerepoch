...
import Images (simeonRunNavLogo, simeonRunNavLogoDark)
import MainFrame.Types (ChildSlots)
import Simeon.PAB (ZerepochAppId)
import Simeon.Semantics (PubKey, Slot)
...
dashboardLinks =
  ...
  [ link "Docs" ""
  , link "simeon-finance.io" "https://simeon-finance.io"
  , link "play.simeon-finance.io" "https://play.simeon-finance.io"
...
contractGrid :: forall m. MonadAff m => Slot -> ContractFilter -> Map ZerepochAppId Contract.State -> ComponentHTML Action ChildSlots m
    ...
    div [ classNames [ "p-5", "pb-6", "md:pb-8" ] ]
      ...
      , div
          ...
          , p
              ...
              [ text $ humanizeValue bccToken $ getBcc assets ]
          ]
      , div
