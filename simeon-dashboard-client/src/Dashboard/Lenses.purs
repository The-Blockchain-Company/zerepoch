...
_contracts :: Lens' State (Map ZerepochAppId Contract.State)
_contracts = prop (SProxy :: SProxy "contracts")

_contract :: ZerepochAppId -> Traversal' State Contract.State
...
_selectedContractFollowerAppId :: Lens' State (Maybe ZerepochAppId)
