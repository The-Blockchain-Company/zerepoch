...
import Simeon.Semantics (SimeonData, SimeonParams, Slot)
...
type State
  = { walletDataState :: WalletData.State
    ...
    , contracts :: Map ZerepochAppId Contract.State
    , contractFilter :: ContractFilter
    , selectedContractFollowerAppId :: Maybe ZerepochAppId
...
data Card
  ...
  | ContractActionConfirmationCard ZerepochAppId NamedAction
...
data Action
  ...
  | SelectContract (Maybe ZerepochAppId)
  | UpdateFromStorage
  | UpdateFollowerApps (Map SimeonParams SimeonData)
  | UpdateContract ZerepochAppId ContractHistory
  | RedeemPayments ZerepochAppId
  | AdvanceTimedoutSteps
  | TemplateAction Template.Action
  | ContractAction ZerepochAppId Contract.Action
