...
import Simeon.Semantics (SimeonParams, Party, Payment, TransactionInput)
...
_mSimeonParams :: Lens' State (Maybe SimeonParams)
_mSimeonParams = prop (SProxy :: SProxy "mSimeonParams")
