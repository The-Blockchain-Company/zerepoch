...
activateContract ::
  ...
  MonadAff m =>
  ContractActivationArgs SimeonContract -> m ContractInstanceId
...
getContractInstanceClientState ::
  ...
  MonadError AjaxError m =>
  MonadAff m =>
  ContractInstanceId -> m (ContractInstanceClientState SimeonContract)
...
getWalletContractInstances ::
  ...
  MonadError AjaxError m =>
  MonadAff m =>
  Wallet -> m (Array (ContractInstanceClientState SimeonContract))
...
getAllContractInstances ::
  ...
  MonadError AjaxError m =>
  MonadAff m =>
  m (Array (ContractInstanceClientState SimeonContract))
...
getContractDefinitions ::
  ...
  MonadError AjaxError m =>
  MonadAff m =>
  m (Array (ContractSignatureResponse SimeonContract))
