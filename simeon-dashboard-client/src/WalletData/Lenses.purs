...
import Simeon.Semantics (Assets, SimeonData, SimeonParams, PubKey)
...
_companionAppId :: Lens' WalletDetails ZerepochAppId
_companionAppId = prop (SProxy :: SProxy "companionAppId")

_simeonAppId :: Lens' WalletDetails ZerepochAppId
_simeonAppId = prop (SProxy :: SProxy "simeonAppId")
...
_previousCompanionAppState :: Lens' WalletDetails (Maybe (Map SimeonParams SimeonData))
