...
type WalletDetails
  = { walletNickname :: WalletNickname
    , companionAppId :: ZerepochAppId
    , simeonAppId :: ZerepochAppId
    ...
    , previousCompanionAppState :: Maybe (Map SimeonParams SimeonData)
    }
...
-- TODO: move this into Simeon.Semantics
newtype PubKeyHash
  = PubKeyHash String
...
data Action
  ...
  | UseWallet WalletNickname ZerepochAppId
