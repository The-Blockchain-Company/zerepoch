...
import           Bcc.Wallet.Types                (MultiWalletEffect (..), WalletEffects, WalletInfo (..),
                                                      WalletMsg (..), Wallets)
...
distributeNewWalletFunds = WAPI.payToPublicKey WAPI.defaultSlotRange (Bcc.bccValueOf 10000)
