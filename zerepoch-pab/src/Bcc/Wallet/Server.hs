...
import           Bcc.ChainIndex.Types            (ChainIndexUrl (..))
import           Bcc.Node.Client                 as NodeClient
import qualified Bcc.Protocol.Socket.Mock.Client as MockClient
import           Bcc.Wallet.API                  (API)
import           Bcc.Wallet.Mock
import           Bcc.Wallet.Types                (Port (..), WalletConfig (..), WalletInfo (..), WalletMsg (..),
