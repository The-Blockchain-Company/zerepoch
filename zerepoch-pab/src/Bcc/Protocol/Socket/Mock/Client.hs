...
{-|
   ...
   `Bcc.Protocol.Socket.Client` module which connects to a real bcc node.
-}
module Bcc.Protocol.Socket.Mock.Client where
...
import qualified Shardagnostic.Network.Protocol.LocalTxSubmission.Client as TxSubmission

import           Ledger.TimeSlot                                     (SlotConfig, currentSlot)
import           Shardagnostic.Network.IOManager
import           Shardagnostic.Network.Mux
import           Shardagnostic.Network.NodeToClient                      (NodeToClientProtocols (..), connectTo,
                                                                      versionedNodeToClientProtocols)
import           Shardagnostic.Network.Snocket
import           Shardagnostic.Network.Socket

import           Bcc.Protocol.Socket.Client                      (ChainSyncHandle (..))
