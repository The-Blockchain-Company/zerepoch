...
module Zerepoch.PAB.Webserver.API
    ( API
    , WSAPI
    , WalletProxy
    ) where

import qualified Bcc.Wallet.API         as Wallet
import qualified Data.Aeson                 as JSON
import           Data.Text                  (Text)
import           Zerepoch.PAB.Webserver.Types (ContractActivationArgs, ContractInstanceClientState,
