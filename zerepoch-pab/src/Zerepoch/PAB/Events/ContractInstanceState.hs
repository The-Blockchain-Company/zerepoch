...
module Zerepoch.PAB.Events.ContractInstanceState(
...
import qualified Zerepoch.Contract.Resumable      as Contract
import qualified Zerepoch.Contract.State          as Contract
