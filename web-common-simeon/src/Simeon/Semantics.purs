...
instance encodeJsonBcc :: Encode Bcc where
  encode a = genericEncode aesonCompatibleOptions a

instance decodeJsonBcc :: Decode Bcc where
  decode a = genericDecode aesonCompatibleOptions a

derive instance genericBcc :: Generic Bcc _

derive instance newtypeBcc :: Newtype Bcc _

derive instance eqBcc :: Eq Bcc

derive instance ordBcc :: Ord Bcc

derive newtype instance showBcc :: Show Bcc

derive newtype instance semiringBcc :: Semiring Bcc

derive newtype instance ringBcc :: Ring Bcc

derive newtype instance euclideanRingBcc :: EuclideanRing Bcc

instance commutativeRingBcc :: CommutativeRing Bcc
...
derive instance eqSimeonData :: Eq SimeonData

derive instance newtypeSimeonData :: Newtype SimeonData _

derive instance genericSimeonData :: Generic SimeonData _

instance encodeSimeonData :: Encode SimeonData where
  encode a = genericEncode aesonCompatibleOptions a

instance decodeSimeonData :: Decode SimeonData where
  decode a = genericDecode aesonCompatibleOptions a

_simeonContract :: Lens' SimeonData Contract
_simeonContract = _Newtype <<< prop (SProxy :: SProxy "simeonContract")

_simeonState :: Lens' SimeonData State
_simeonState = _Newtype <<< prop (SProxy :: SProxy "simeonState")

newtype SimeonParams
  = SimeonParams
  { rolePayoutValidatorHash :: ValidatorHash
  , rolesCurrency :: { unCurrencySymbol :: CurrencySymbol } -- this is to ensure the serialisation matches the backend
  }

derive instance eqSimeonParams :: Eq SimeonParams

derive instance ordSimeonParams :: Ord SimeonParams

derive instance newtypeSimeonParams :: Newtype SimeonParams _

derive instance genericSimeonParams :: Generic SimeonParams _

instance encodeSimeonParams :: Encode SimeonParams where
  encode a = genericEncode aesonCompatibleOptions a

instance decodeSimeonParams :: Decode SimeonParams where
  decode a = genericDecode aesonCompatibleOptions a

_rolePayoutValidatorHash :: Lens' SimeonParams ValidatorHash
_rolePayoutValidatorHash = _Newtype <<< prop (SProxy :: SProxy "rolePayoutValidatorHash")

_rolesCurrency :: Lens' SimeonParams CurrencySymbol
