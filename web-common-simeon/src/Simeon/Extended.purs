...
import Simeon.Semantics (decodeProp)
...
-- TODO: Should this be in here or in Simeon.Template?
...
-- In the extended simeon we are treating Slot's as relative times to an initial slot and the
