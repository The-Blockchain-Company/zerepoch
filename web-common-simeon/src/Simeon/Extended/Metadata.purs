module Simeon.Extended.Metadata where
...
import Simeon.Extended (Contract, ContractType(..), getChoiceNames)
...
import Simeon.Template (Placeholders(..), getPlaceholderIds)
...
entropicFormat :: NumberFormat
entropicFormat = DecimalFormat 6 "₳"
