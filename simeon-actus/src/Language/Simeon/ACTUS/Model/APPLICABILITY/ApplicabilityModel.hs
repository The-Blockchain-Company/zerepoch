...
module Language.Simeon.ACTUS.Model.APPLICABILITY.ApplicabilityModel where

import           Data.Validation                                  (Validation (..))
import           Language.Simeon.ACTUS.Definitions.ContractTerms (ContractTerms (..), IPCB (IPCB_NTIED, IPCB_NTL),
                                                                   TermValidationError (..))
