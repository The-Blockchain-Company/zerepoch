...
module Language.Simeon.ACTUS.Model.SCHED.ContractSchedule
  ( schedule
  , maturity
  )
where
...
import           Language.Simeon.ACTUS.Definitions.ContractTerms         (CT (..), ContractTerms (..), Cycle (..),
                                                                           ScheduleConfig (..))
import           Language.Simeon.ACTUS.Definitions.Schedule              (ShiftedDay (..))
import           Language.Simeon.ACTUS.Model.SCHED.ContractScheduleModel
import           Language.Simeon.ACTUS.Model.Utility.DateShift           (applyBDCWithCfg)
import           Language.Simeon.ACTUS.Model.Utility.ScheduleGenerator   (applyEOMC,
