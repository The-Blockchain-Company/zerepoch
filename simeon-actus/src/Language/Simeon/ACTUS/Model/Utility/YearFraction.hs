module Language.Simeon.ACTUS.Model.Utility.YearFraction where

import           Data.Time                                        (Day, diffDays, fromGregorian, gregorianMonthLength,
                                                                   isLeapYear, toGregorian)
import           Language.Simeon.ACTUS.Definitions.ContractTerms (DCC (DCC_A_360, DCC_A_365, DCC_A_AISDA, DCC_E30_360, DCC_E30_360ISDA))
