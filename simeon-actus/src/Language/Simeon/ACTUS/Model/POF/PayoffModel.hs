module Language.Simeon.ACTUS.Model.POF.PayoffModel where

import           Language.Simeon.ACTUS.Definitions.ContractTerms (CR (..), FEB (FEB_A, FEB_N),
                                                                   PYTP (PYTP_A, PYTP_I, PYTP_N, PYTP_O))
import           Language.Simeon.ACTUS.Ops                       (ActusNum (..), ActusOps (_abs, _max, _zero),
                                                                   RoleSignOps (_r))
