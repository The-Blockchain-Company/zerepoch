...
-- https://github.com/actusfrf/actus-tests/pull/1
  ...
  defaultMain $ testGroup "ACTUS Contracts"
    [
      Spec.Simeon.Actus.tests "PAM" pamTests
    , Spec.Simeon.Actus.tests "LAM" lamTests
--    , Spec.Simeon.Actus.tests "NAM" namTests
--    , Spec.Simeon.Actus.tests "ANN" annTests
    ]
