module SimeonEditor.Types where
...
defaultEvent s = A.defaultEvent $ "SimeonEditor." <> s
...
instance actionIsEvent :: IsEvent Action where
  ...
  toEvent (InitSimeonProject _) = Just $ defaultEvent "InitSimeonProject"
