module SimeonEditor.BottomPanel
  ( panelContents
  ) where
...
import SimeonEditor.Types (Action(..), BottomPanelView(..), State, _editorErrors, _editorWarnings, _hasHoles, _metadataHintInfo, _showErrorDetail, contractHasErrors)
...
panelContents state _ SimeonWarningsView =
  section_
...
panelContents state _ SimeonErrorsView =
  section_
