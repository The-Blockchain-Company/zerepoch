...
instance actionIsEvent :: IsEvent Action where
  ...
  toEvent (SimeonEditorAction action) = toEvent action
...
type ChildSlots
  = ( haskellEditorSlot :: H.Slot Monaco.Query Monaco.Message Unit
    ...
    , simeonEditorPageSlot :: H.Slot Monaco.Query Monaco.Message Unit
...
_simeonEditorPageSlot :: SProxy "simeonEditorPageSlot"
_simeonEditorPageSlot = SProxy
...
type State
  = { view :: View
    ...
    -- simeon/blockly and run in the simulator, or can create a simeon/blockly contract directly,
...
_simeonEditorState :: Lens' State ME.State
_simeonEditorState = prop (SProxy :: SProxy "simeonEditorState")
