...
import Halogen.Classes (arrowLeftDown, arrowLeftUp, arrowRightDown, arrowRightUp, simeonLogo, newProjectBlocklyIcon, newProjectHaskellIcon, newProjectJavascriptIcon, primaryButton, secondaryButton, simulationIconBlack)
  ...
  div [ classNames [ "flex", "flex-col", "items-center", "my-16" ] ]
    ...
    , div
        ...
        , div
            ...
            , onClick (const <<< Just $ NewProjectAction $ NewProject.CreateProject Simeon)
            ]
            [ img [ src simeonLogo, classNames [ "h-16", "mb-4" ] ]
            , text
                "Start in Simeon"
            ]
    ...
    , div [ classNames [ "font-bold", "text-sm" ] ]
        [ a [ href "./doc/simeon/tutorials/index.html", target "_blank" ] [ text "Read our Getting Started guide" ]
        ]
    ]
  where
