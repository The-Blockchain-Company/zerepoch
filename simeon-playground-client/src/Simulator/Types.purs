...
import Simeon.Holes (Holes, Term)
import Simeon.Holes as T
import Simeon.Semantics (AccountId, Assets, Bound, ChoiceId, ChosenNum, Input, Party(..), Payment, Slot, SlotInterval, Token, TransactionError, TransactionInput, TransactionWarning, aesonCompatibleOptions)
...
otherActionsParty = Role "simeon_other_actions"
...
type SimeonState
  = { executionState :: ExecutionState
    , holes :: Holes
    -- NOTE: as part of the simeon editor and simulator split this part of the
