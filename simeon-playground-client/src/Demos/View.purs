...
render state =
  div_
    ...
    , div [ classes [ modalContent, ClassName "projects-container" ] ]
        ...
        , demoFile (wrap "Swap") "Swap" "Takes Bcc from one party and dollar tokens from another party, and it swaps them atomically."
        , demoFile (wrap "CFD") "Contract For Differences" "\"Party\" and \"Counterparty\" deposit 100 Bcc and after 60 slots is redistributed depending on the change in a given trade price reported by \"Oracle\". If the price increases, the difference goes to \"Counterparty\"; if it decreases, the difference goes to \"Party\", up to a maximum of 100 Bcc."
        , demoFile (wrap "CFDWithOracle") "Contract For Differences with Oracle" "\"Party\" and \"Counterparty\" deposit 100 Bcc and after 60 slots these assets are redistributed depending on the change in price of 100 Bcc worth of dollars between the start and the end of the contract. If the price increases, the difference goes to \"Counterparty\"; if it decreases, the difference goes to \"Party\", up to a maximum of 100 Bcc."
        ]
    ]
    ...
    , div [ class_ group ]
        ...
        , div [ classes [ group, ClassName "open-buttons" ] ]
            ...
            , button
                ...
                [ text "Javascript" ]
            , button
                [ onClick $ const $ Just $ LoadDemo Simeon key
                , classNames [ "btn" ]
                ]
                [ text "Simeon" ]
            , button
