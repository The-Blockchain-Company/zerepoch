...
import Help as Help
import Simeon.LinterText (AdditionalContext)
...
languageExtensionPoint = LanguageExtensionPoint { id: "simeon" }

daylightTheme :: Theme
daylightTheme = { name: "simeon-playground-daylight", themeData: daylightTheme_ }
...
refLabel :: RefLabel
refLabel = RefLabel "simeonEditor"
