...
const monaco = require('src/Simeon/Monaco.ts');

exports.hoverProvider_ = function (hoverProvider) {
    return new monaco.SimeonHoverProvider(hoverProvider);
}
...
exports.completionItemProvider_ = function (suggestionsProvider) {
    ...
    return new monaco.SimeonCompletionItemProvider(uncurriedSuggestions);
}
...
exports.codeActionProvider_ = function (provideCodeActions, additionalContext) {
    ...
    return new monaco.SimeonCodeActionProvider(uncurriedProvideCodeActions, additionalContext);
}
...
exports.documentFormattingEditProvider_ = function (format) {
    return new monaco.SimeonDocumentFormattingEditProvider(format);
}

exports.tokensProvider = new monaco.SimeonTokensProvider();
