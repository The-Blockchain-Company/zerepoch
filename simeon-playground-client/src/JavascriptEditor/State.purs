...
import Simeon.Extended (Contract)
import Simeon.Extended.Metadata (MetadataHintInfo, getMetadataHintInfo)
import Simeon.Template (getPlaceholderIds, typeToLens, updateTemplateContent)
...
decorationHeader =
  """import {
    PK, Role, Account, Party, bcc, AvailableMoney, Constant, ConstantParam,
