...
compilationErrorPane (JSONParsingError error) = div_ [ text "There was an error when parsing the resulting JSON:", code_ [ pre_ [ text $ error ] ], text "Please, use the JS API provided (see tutorial and examples). If you did use the JS API and still get this error, kindly report the problem at ", a [ href "https://github.com/The-Blockchain-Company/zerepoch/issues/new" ] [ text "https://github.com/The-Blockchain-Company/zerepoch/issues/new" ], text " including the code that caused the error. Thank you" ]
