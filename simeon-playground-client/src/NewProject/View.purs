...
import Halogen.Classes (fontSemibold, simeonLogo, modalContent, newProjectBlocklyIcon, newProjectHaskellIcon, newProjectJavascriptIcon, textBase, textSm)
...
render state =
  div_
    ...
    , div [ classes [ modalContent, ClassName "new-project-container" ] ]
        ...
        , div [ classes [ ClassName "environment-selector-group" ] ] (map link [ Haskell, Javascript, Simeon, Blockly ])
