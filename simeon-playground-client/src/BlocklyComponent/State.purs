...
import Simeon.Blockly (buildBlocks)
import Simeon.Holes (Term(..), Location(..))
import Simeon.Linter (_location)
import Simeon.Parser as Parser
...
locationToBlockId (Range _) = unsafeThrow "Unexpected Range location found in SimeonParser"

locationToBlockId NoLocation = unsafeThrow "Unexpected NoLocation found in SimeonParser"
...
-- See PR https://github.com/The-Blockchain-Company/zerepoch/pull/2787
