module Simeon.Holes.TemplateTest where
...
import Simeon.Gen (genBigInteger, genContract, GenerationOptions(..))
import Simeon.GenWithHoles (GenWithHoles, contractQuickCheck)
import Simeon.Holes (fromTerm)
import Simeon.Semantics as S
import Simeon.Template (Placeholders(..), TemplateContent(..), fillTemplate, getPlaceholderIds)
import Test.QuickCheck (Result(..), (===))
import Test.Unit (TestSuite, suite, test)

all :: TestSuite
all =
  suite "Simeon.Holes.Template" do
    let
