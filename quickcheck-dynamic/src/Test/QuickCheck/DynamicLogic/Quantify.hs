...
--   `Zerepoch.Contract.Test.ContractModel.forAllQ` to generate random values in
...
--
-- @
-- `Zerepoch.Contract.Test.ContractModel.forAllQ` (`elementsQ` []) == `Control.Applicative.empty`
-- @
...
-- @
--   ...
--   (die1, die2) <- `Zerepoch.Contract.Test.ContractModel.forAllQ` (`chooseQ` (1, 6), `chooseQ` (1, 6))
--   ...
-- @
