...
module ZerepochIR.TypeCheck.Internal
    ( BuiltinTypes (..)
    , TypeCheckConfig (..)
    , TypeCheckM
    , tccBuiltinTypes
...
import           Data.Ix
import           ZerepochCore                    (ToKind (..), typeAnn)
import           ZerepochCore.Error              as PLC
import           ZerepochCore.Quote
import           ZerepochCore.Rename             as PLC
import           ZerepochIR
import           ZerepochIR.Compiler.Datatype
...
-- we mirror inferTypeM, checkTypeM of plc-tc and extend it for zerepoch-ir terms
import           ZerepochCore.TypeCheck.Internal hiding (checkTypeM, inferTypeM, runTypeCheckM)
...
See Note [Notation] of ZerepochCore.TypeCheck.Internal for the notation of inference rules, which appear in the comments.
-}
...
See NOTE [Normalization of data-constructors' types] at ZerepochIR.Compiler.Datatype
-}
...
-- ##########################
--  Taken from `ZerepochCore.Typecheck.Internal`
