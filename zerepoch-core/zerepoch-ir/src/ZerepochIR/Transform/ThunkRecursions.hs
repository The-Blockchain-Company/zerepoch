...
module ZerepochIR.Transform.ThunkRecursions (thunkRecursions) where
...
Our fixpoint combinators in Zerepoch Core know how to handle mutually recursive values
