...
module ZerepochIR.Analysis.RetainedSize
    ( RetainedSize (..)
    , termRetentionMap
...
import           ZerepochIR.Analysis.Dependencies
import           ZerepochIR.Analysis.Size
import           ZerepochIR.Core

import qualified ZerepochCore                     as PLC
import           ZerepochCore.Constant            (ToBuiltinMeaning)
