...
module ZerepochIR.Analysis.Dependencies (Node (..), DepGraph, StrictnessMap, runTermDeps, runTypeDeps) where
...
import           ZerepochIR
import qualified ZerepochIR.Analysis.Usages as Usages
