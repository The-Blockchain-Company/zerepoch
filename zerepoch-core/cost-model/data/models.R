...
## zerepoch-core:cost-model-budgeting-bench using the code in zerepoch-core/budgeting-bench/Bench.hs.
...
## numbers are much easier to work with interactively.  For use in the Zerepoch
