...
module ZerepochCore.TypeCheck.Internal
...
import qualified ZerepochCore.Normalize.Internal as Norm
...
Since Zerepoch Core is a fully elaborated language, this amounts to inferring the type of 'x' and
...
unfoldIFixOf pat arg k = do
    ...
    -- behavior, see https://github.com/The-Blockchain-Company/zerepoch/pull/2219#issuecomment-672815272
