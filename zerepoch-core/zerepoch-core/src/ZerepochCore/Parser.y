...
import ZerepochCore.Parser.Internal

import ZerepochCore.Constant.Typed
import ZerepochCore.Core
import ZerepochCore.Core.Type
import ZerepochCore.Default
import ZerepochCore.Error
import ZerepochCore.Lexer
import ZerepochCore.Lexer.Type
import ZerepochCore.Mark
import ZerepochCore.MkPlc           (mkTyBuiltin, mkConstant)
import ZerepochCore.Name
import ZerepochCore.Parsable
...
%name parseZerepochCoreProgram Program
%name parseZerepochCoreTerm Term
%name parseZerepochCoreType Type
...
-- See https://github.com/The-Blockchain-Company/zerepoch/pull/2458#issuecomment-725706274
...
parseProgram str = mapParseRun $ parseST parseZerepochCoreProgram str
...
parseTerm str = mapParseRun $ parseST parseZerepochCoreTerm str
...
parseType str = mapParseRun $ parseST parseZerepochCoreType str
}
