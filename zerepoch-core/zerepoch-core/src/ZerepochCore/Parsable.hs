...
modify the main Zerepoch Core parser. We expect parseConstant . prettyConst to be
the identity function. -}

module ZerepochCore.Parsable
    (
     Parsable(..)
    )
where
...
There are arguments in favor of the former option (https://github.com/The-Blockchain-Company/zerepoch/pull/2458#discussion_r522091227):
