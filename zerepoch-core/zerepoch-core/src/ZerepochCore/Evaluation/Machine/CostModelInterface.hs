...
module ZerepochCore.Evaluation.Machine.CostModelInterface
    ( CostModelParams
    , CekMachineCosts
...
import           ZerepochCore.Evaluation.Machine.MachineParameters          (CostModel (..))
import           UntypedZerepochCore.Evaluation.Machine.Cek.CekMachineCosts (CekMachineCosts, cekMachineCostsPrefix)
...
CostModelParams objects should never contain such large numbers. Any Zerepoch Core
