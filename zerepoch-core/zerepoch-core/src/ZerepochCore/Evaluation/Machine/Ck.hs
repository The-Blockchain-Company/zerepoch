...
module ZerepochCore.Evaluation.Machine.Ck
    ( EvaluationResult (..)
...
import           ZerepochCore.Pretty                       (PrettyConfigPlc, PrettyConst)
...
instance Pretty CkUserError where
    pretty CkEvaluationFailure = "The provided Zerepoch code called 'error'."
