...
module ZerepochCore.Pretty.PrettyConst where
...
`ZerepochCore.Core.Instance.Pretty.Classic`.  The constraint
...
-- | Special treatment for built-in constants: see the Note in ZerepochCore.Pretty.PrettyConst.
