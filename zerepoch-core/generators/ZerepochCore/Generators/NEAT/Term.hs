...
This file contains
1. A duplicate of the Zerepoch Core Abstract Syntax (types and terms)
...
module ZerepochCore.Generators.NEAT.Term
  ( TypeBuiltinG (..)
  , TermConstantG (..)
  , TypeG (..)
  , ClosedTypeG
...
import           ZerepochCore.Generators.NEAT.Common
import           Text.Printf

import           ZerepochCore.Generators.NEAT.Type
...
NOTE: We don't just want to enumerate arbitrary types but also normal
     ...
     normalized/neutral. This is how it's done in the zerepoch-core
...
-- |Convert generated builtin types to Zerepoch builtin types.
...
-- |Convert well-kinded generated types to Zerepoch types.
--
...
-- |Convert generated closed types to Zerepoch types.
convertClosedType
...
-- |Convert (well-typed) generated terms to Zerepoch terms.
--
...
-- |Convert generated closed terms to Zerepoch terms.
convertClosedTerm
  :: (MonadQuote m, MonadError GenError m)
  => Stream.Stream Text.Text
  -> Stream.Stream Text.Text
