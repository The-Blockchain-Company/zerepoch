{-| Description : Property based testing for Zerepoch Core
...
module ZerepochCore.Generators.NEAT.Spec
  ( tests
  , GenOptions (..)
  , defaultGenOptions
  , Options (..)
...
import           ZerepochCore.Generators.NEAT.Term
import           ZerepochCore.Normalize
import           ZerepochCore.Pretty

import qualified UntypedZerepochCore                        as U
import qualified UntypedZerepochCore.Evaluation.Machine.Cek as U
...
--       - we encounter an error while type checking Zerepoch terms;
