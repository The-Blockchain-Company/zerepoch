...
module UntypedZerepochCore.Evaluation.Machine.Cek.Internal
...
import           UntypedZerepochCore.Evaluation.Machine.Cek.CekMachineCosts (CekMachineCosts (..))
...
instance Pretty CekUserError where
    ...
    pretty CekEvaluationFailure = "The provided Zerepoch code called 'error'."
