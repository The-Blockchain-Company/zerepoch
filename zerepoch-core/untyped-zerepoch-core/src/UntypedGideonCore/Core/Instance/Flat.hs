...
module UntypedZerepochCore.Core.Instance.Flat where
...
{-
The definitions in this file rely on some Flat instances defined for typed zerepoch core.
You can find those in ZerepochCore.Flat.
-}
