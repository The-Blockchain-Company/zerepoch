-- | A "classic" (i.e. as seen in the specification) way to pretty-print Untyped Zerepoch Core terms.
...
module UntypedZerepochCore.Core.Instance.Pretty.Classic () where

import           ZerepochPrelude

import           UntypedZerepochCore.Core.Type

import           ZerepochCore.Core.Instance.Pretty.Common ()
