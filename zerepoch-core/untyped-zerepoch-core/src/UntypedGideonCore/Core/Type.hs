...
module UntypedZerepochCore.Core.Type
    ( TPLC.UniOf
    , TPLC.Version (..)
    , TPLC.Binder (..)
    , Term (..)
...
import qualified ZerepochCore.Constant   as TPLC
import qualified ZerepochCore.Core       as TPLC
import           ZerepochCore.MkPlc
import qualified ZerepochCore.Name       as TPLC
import           Universe
...
{-| The type of Untyped Zerepoch Core terms. Mirrors the type of Typed Zerepoch Core terms except
...
The latter two are due to the fact that we don't have value restriction in Typed Zerepoch Core
...
-- | Erase a Typed Zerepoch Core term to its untyped counterpart.
...
-- | Erase a Typed Zerepoch Core Program to its untyped counterpart.
