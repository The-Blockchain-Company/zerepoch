...
import           ZerepochCore.MkPlc                                hiding (error)
...
import qualified ZerepochCore.StdLib.Data.List                     as Builtin
import           ZerepochCore.StdLib.Data.Pair
import qualified ZerepochCore.StdLib.Data.ScottList                as Scott
...
-- See https://github.com/The-Blockchain-Company/zerepoch/issues/1882
test_Id :: TestTree
test_Id =
    testCase "Id" $ do
...
-- | Test all ZerepochData builtins
test_Data :: TestTree
