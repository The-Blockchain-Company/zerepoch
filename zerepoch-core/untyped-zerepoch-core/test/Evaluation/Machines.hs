...
import           UntypedZerepochCore.Evaluation.HOAS
import           UntypedZerepochCore.Evaluation.Machine.Cek        as Cek
...
import qualified ZerepochCore.StdLib.Data.Nat                      as Plc
import           ZerepochCore.StdLib.Meta
import           ZerepochCore.StdLib.Meta.Data.Function            (etaExpand)
...
test_budget
    = runTestNestedIn ["untyped-zerepoch-core", "test", "Evaluation", "Machines"]
    . testNested "Budget"
    $ concat
