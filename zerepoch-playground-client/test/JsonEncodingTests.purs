      ...
      let
        aValue =
          Value
            { getValue:
                AssocMap.fromTuples
                  [ Tuple (CurrencySymbol { unCurrencySymbol: "0" }) (AssocMap.fromTuples [ Tuple (TokenName { unTokenName: "BCC" }) (BigInteger.fromInt 10) ])
      ...
      let
        aValue =
          Value
            { getValue:
                AssocMap.fromTuples
                  [ Tuple (CurrencySymbol { unCurrencySymbol: "0" }) (AssocMap.fromTuples [ Tuple (TokenName { unTokenName: "BCC" }) (BigInteger.fromInt 100) ])
