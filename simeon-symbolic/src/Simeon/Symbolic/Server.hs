...
module Simeon.Symbolic.Server where
...
import           Language.Simeon                      (Contract, Slot (Slot), State, TransactionInput,
                                                        TransactionWarning)
import           Language.Simeon.Analysis.FSSemantics (warningsTraceCustom)
import           Simeon.Symbolic.Types.Request        (Request (..))
...
type API = "api" :> "simeon-analysis" :> ReqBody '[JSON] Request :> Post '[JSON] Response
