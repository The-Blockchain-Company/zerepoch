...
module Zerepoch.Contracts.Uniswap.Types
  where
...
ZerepochTx.makeIsDataIndexed ''U [('U, 0)]
ZerepochTx.makeLift ''U

-- | "A"-side coin token
data A = A
ZerepochTx.makeIsDataIndexed ''A [('A, 0)]
ZerepochTx.makeLift ''A

-- | "B"-side coin token
data B = B
ZerepochTx.makeIsDataIndexed ''B [('B, 0)]
ZerepochTx.makeLift ''B

-- | Pool-state coin token
data PoolState = PoolState
ZerepochTx.makeIsDataIndexed ''PoolState [('PoolState, 0)]
ZerepochTx.makeLift ''PoolState

-- | Liquidity-state coin token
data Liquidity = Liquidity
ZerepochTx.makeIsDataIndexed ''Liquidity [('Liquidity, 0)]
ZerepochTx.makeLift ''Liquidity
...
ZerepochTx.makeIsDataIndexed ''Coin [('Coin, 0)]
ZerepochTx.makeLift ''Coin
...
ZerepochTx.makeIsDataIndexed ''Amount [('Amount, 0)]
ZerepochTx.makeLift ''Amount
...
ZerepochTx.makeIsDataIndexed ''Uniswap [('Uniswap, 0)]
ZerepochTx.makeLift ''Uniswap
...
ZerepochTx.makeIsDataIndexed ''LiquidityPool [('LiquidityPool, 0)]
ZerepochTx.makeLift ''LiquidityPool
...
ZerepochTx.makeIsDataIndexed ''UniswapAction [ ('Create , 0)
                                           , ('Close,   1)
                                           , ('Swap,    2)
                                           , ('Remove,  3)
                                           , ('Add,     4)
                                           ]
ZerepochTx.makeLift ''UniswapAction

data UniswapDatum =
      Factory [LiquidityPool]
    | Pool LiquidityPool (Amount Liquidity)
    deriving stock (Haskell.Show)
ZerepochTx.makeIsDataIndexed ''UniswapDatum [ ('Factory, 0)
                                          , ('Pool,    1)
                                          ]
ZerepochTx.makeLift ''UniswapDatum
