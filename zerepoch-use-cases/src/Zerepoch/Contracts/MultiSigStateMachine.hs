...
module Zerepoch.Contracts.MultiSigStateMachine(
    -- $multisig
      Params(..)
    , Payment(..)
    , State
...
import           ZerepochTx.Prelude             hiding (Applicative (..))
...
--   'Zerepoch.Contracts.MultiSig' expects n signatures on
...
ZerepochTx.unstableMakeIsData ''Payment
ZerepochTx.makeLift ''Payment
ZerepochTx.unstableMakeIsData ''MSState
ZerepochTx.makeLift ''MSState
ZerepochTx.makeLift ''Params
