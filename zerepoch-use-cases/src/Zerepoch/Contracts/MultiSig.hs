...
module Zerepoch.Contracts.MultiSig
    ( MultiSig(..)
    , MultiSigSchema
    , contract
    , lock
...
import qualified Zerepoch.Contract.Typed.Tx as Tx
import qualified ZerepochTx
import           ZerepochTx.Prelude         hiding (Semigroup (..), foldMap)
