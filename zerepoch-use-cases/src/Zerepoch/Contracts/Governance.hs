...
-- | A basic governance contract in Zerepoch.
module Zerepoch.Contracts.Governance (
    -- $governance
      contract
    , proposalContract
    , Params(..)
...
ZerepochTx.unstableMakeIsData ''Proposal
ZerepochTx.makeLift ''Proposal
ZerepochTx.unstableMakeIsData ''Voting
ZerepochTx.makeLift ''Voting
ZerepochTx.unstableMakeIsData ''GovState
ZerepochTx.makeLift ''GovState
ZerepochTx.unstableMakeIsData ''GovInput
ZerepochTx.makeLift ''GovInput
