...
, wallet ? "1"
  ...
  nodeServerConfig:
    ...
    mscSlotConfig:
      scSlotZeroTime: 1596059091000 # POSIX time of 2020-07-29T21:44:51Z (Wednesday, July 29, 2020 21:44:51) - Sophie launch time
      scSlotLength: 1000 # In milliseconds
    mscFeeConfig:
      fcConstantFee:
        getEntropic: 10 # Constant fee per transaction in entropic
      fcScriptsFeeFactor: 1.0 # Factor by which to multiply the size-dependent scripts fee in entropic
