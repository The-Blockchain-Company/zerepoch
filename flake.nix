...
{
  description = "zerepoch flake for pinning sources and bitte deployments";
  ...
  inputs = {
    ...
    haskell-nix = {
      # We pin this revision to avoid mass-rebuilds from the auto-update process.
      url = "github:The-Blockchain-Company/haskell.nix?rev=7215f083b37741446aa325b20c8ba9f9f76015eb";
    ...
    bcc-repo-tool = {
      url = "github:The-Blockchain-Company/bcc-repo-tool";
    ...
    hackage-nix = {
      ...
      url = "github:The-Blockchain-Company/hackage.nix?rev=23545a41ef50c4328e3f95b9a63db59f3ada3518";
    ...
    stackage-nix = {
      # We pin this revision to avoid unhelpful daily churn from the auto-update process.
      url = "github:The-Blockchain-Company/stackage.nix?rev=e32c8b06d56954865725514ce0d98d5d1867e43a";
