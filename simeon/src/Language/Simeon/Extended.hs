...
{-| = Extended Simeon: adds templating functionality to Simeon language
Extended Simeon is not executable, it is translated to core Simeon before
...
module Language.Simeon.Extended ( module Language.Simeon.Extended
                                 , module Language.Simeon.Pretty
                                 , bcc, bccSymbol, bccToken
...
import           Data.Ratio                 ((%))
import           GHC.Generics
import           Language.Simeon.Pretty    (Pretty (..), pretty)
import qualified Language.Simeon.Semantics as S
