...
module Zerepoch.ChainIndex.Client(
    -- * HTTP Client handler
...
import           Zerepoch.ChainIndex.Api        (API)
import           Zerepoch.ChainIndex.Effects    (ChainIndexQueryEffect (..))
import           Zerepoch.ChainIndex.Tx         (ChainIndexTx)
import           Zerepoch.ChainIndex.Types      (Page, Tip)
