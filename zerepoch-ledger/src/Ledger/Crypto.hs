...
import qualified Zerepoch.V1.Ledger.Bytes  as KB
import           Zerepoch.V1.Ledger.Crypto as Export hiding (PrivateKey)
...
--         do this in 'Crypto.ECC.Ed25519Donna' in 'bcc-crypto')
