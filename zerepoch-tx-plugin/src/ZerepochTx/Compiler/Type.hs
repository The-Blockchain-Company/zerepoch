...
-- | Functions for compiling GHC types into ZerepochCore types, as well as compiling constructors,
-- matchers, and pattern match alternatives.
module ZerepochTx.Compiler.Type (
    compileTypeNorm,
    compileType,
    compileKind,
    getDataCons,
...
import           ZerepochTx.Compiler.Kind
