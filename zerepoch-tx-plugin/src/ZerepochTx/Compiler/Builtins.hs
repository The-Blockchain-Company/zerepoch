...
-- | Functions for compiling Zerepoch Core builtins.
module ZerepochTx.Compiler.Builtins (
    builtinNames
    , defineBuiltinTypes
    , defineBuiltinTerms
    , lookupBuiltinTerm
...
import qualified ZerepochTx.Builtins.Internal    as Builtins
...
We want the user to be able to call the Zerepoch builtins as normal Haskell functions.
