...
Zerepoch Core evaluators.  There's some machinery known as the constant
...
[here](../../../zerepoch-core/docs/Builtins.md) and
[here](../../../zerepoch-core/docs/Constant-application.md).
...
to pursue them: see [this document](../../../zerepoch-core/docs/Saturatedness.md)
...
distinct from, the "values" in the Zerepoch Core specification, which
...
that works directly with values as described in the Zerepoch Core
...
I've considered a number of ways to fix this.
 ...
 2. We could modify the notion of value used in the CK machine. The CK
   ...
   described in the Zerepoch Core specification, which are terms with a
...
more Haskell into Zerepoch Core?  It appears that there's not a huge
