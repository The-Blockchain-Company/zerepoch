...
-- For more details see the document in zerepoch/docs/fomega/lazy-machine
...
module ZerepochCore.Interpreter.LMachine
...
import           ZerepochCore.Evaluation.MachineException
