...
[January 2020, Zerepoch repository at 9c95674]

Following on from [CekProfiling.md](./CekProfiling.md), this takes a closer look at
how cost accounting affects execution costs.

`Language.ZerepochCore.Evaluation.Machine.ExBudgeting` defines the following types for
budgeting:
...
The CEK machine (`Language.UntypedZerepochCore.Evaluation.Machine.Cek`) declares the following
types
...
simeon/trustfund/1   |    21.17   |   14.27    |  13.36
simeon/trustfund/2   |    16.35   |   11.86    |  10.98
simeon/zerocoupon/1  |    22.17   |   14.83    |  13.33
simeon/zerocoupon/2  |    15.06   |   11.10    |  10.33
