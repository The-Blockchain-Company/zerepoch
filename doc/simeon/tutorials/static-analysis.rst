...
One distinctive feature of Simeon – probably its most distinctive
...
.. image:: images/analysis2.png
   :alt: An example contract in Simeon

The contract first requires a deposit from Alice of ``1`` Entropic, and
...
Our analysis, which is built into the SIMULATION tab in the Simeon
...
Use the analysis button in the Simeon Playground to analyse some of the
