...
module Zerepoch.V1.Ledger.Interval(
      Interval(..)
    , UpperBound(..)
    , LowerBound(..)
    , Extended(..)
...
ZerepochTx.makeIsDataIndexed ''Extended [('NegInf,0),('Finite,1),('PosInf,2)]
ZerepochTx.makeIsDataIndexed ''UpperBound [('UpperBound,0)]
ZerepochTx.makeIsDataIndexed ''LowerBound [('LowerBound,0)]
ZerepochTx.makeIsDataIndexed ''Interval [('Interval,0)]
