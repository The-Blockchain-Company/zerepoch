...
newtype MyDatum = MyDatum Integer deriving newtype (ZerepochTx.ToData, ZerepochTx.FromData, ZerepochTx.UnsafeFromData)
ZerepochTx.makeLift ''MyDatum

newtype MyRedeemer = MyRedeemer Integer deriving newtype (ZerepochTx.ToData, ZerepochTx.FromData, ZerepochTx.UnsafeFromData)
ZerepochTx.makeLift ''MyRedeemer
...
starterInstance = Scripts.mkTypedValidator @Starter
    $$(ZerepochTx.compile [|| validateSpend ||])
