...
import           Zerepoch.Contract          (AsContractError (_ContractError), ContractError, awaitTime, logInfo,
                                           mapError, selectList)
import           Prelude                  (Maybe (..), const, show, ($), (+), (.), (<>))

-- Demonstrates how to deal with errors in Zerepoch contracts. We define a custom
...
instance AsContractError MyError where
    ...
    -- 'Zerepoch.Contract.Request'. By making 'MyError' an
