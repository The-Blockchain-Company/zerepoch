...
{-# FOREIGN GHC import ZerepochCore.Name #-}
{-# FOREIGN GHC import ZerepochCore.Lexer #-}
{-# FOREIGN GHC import ZerepochCore.Parser #-}
{-# FOREIGN GHC import ZerepochCore.Pretty #-}
{-# FOREIGN GHC import ZerepochCore.DeBruijn #-}
{-# FOREIGN GHC import qualified UntypedZerepochCore as U #-}
{-# FOREIGN GHC import qualified UntypedZerepochCore.Parser as U #-}
...
{-# COMPILE GHC ProgramN = type ZerepochCore.Program TyName Name DefaultUni DefaultFun ZerepochCore.Lexer.AlexPosn #-}
{-# COMPILE GHC Program = type ZerepochCore.Program NamedTyDeBruijn NamedDeBruijn DefaultUni DefaultFun () #-}
{-# COMPILE GHC TermN = type ZerepochCore.Term TyName Name DefaultUni DefaultFun ZerepochCore.Lexer.AlexPosn #-}
{-# COMPILE GHC Term = type ZerepochCore.Term NamedTyDeBruijn NamedDeBruijn DefaultUni DefaultFun () #-}
{-# COMPILE GHC TypeN = type ZerepochCore.Type TyName DefaultUni ZerepochCore.Lexer.AlexPosn #-}
{-# COMPILE GHC Type = type ZerepochCore.Type NamedTyDeBruijn DefaultUni () #-}
{-# COMPILE GHC showTerm = T.pack . show #-}

{-# COMPILE GHC ProgramNU = type U.Program Name DefaultUni DefaultFun ZerepochCore.Lexer.AlexPosn #-}
{-# COMPILE GHC ProgramU = type U.Program NamedDeBruijn DefaultUni DefaultFun () #-}
{-# COMPILE GHC TermNU = type U.Term Name DefaultUni DefaultFun ZerepochCore.Lexer.AlexPosn #-}
