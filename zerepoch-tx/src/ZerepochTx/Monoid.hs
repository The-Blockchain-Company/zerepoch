...
module ZerepochTx.Monoid (Monoid (..), mappend, mconcat, Group (..), gsub) where
...
-- | Zerepoch Tx version of 'Data.Monoid.Monoid'.
class Semigroup a => Monoid a where
    -- | Zerepoch Tx version of 'Data.Monoid.mempty'.
    mempty :: a
    -- mappend and mconcat deliberately omitted, to make this a one-method class which has a
    -- simpler representation

{-# INLINABLE mappend #-}
-- | Zerepoch Tx version of 'Data.Monoid.mappend'.
mappend :: Monoid a => a -> a -> a
mappend = (<>)

{-# INLINABLE mconcat #-}
-- | Zerepoch Tx version of 'Data.Monoid.mconcat'.
