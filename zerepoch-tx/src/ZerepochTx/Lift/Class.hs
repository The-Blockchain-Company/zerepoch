...
import           ZerepochTx.Lift.THUtils
...
-- | Class for types which have a corresponding Zerepoch IR type. Instances should always be derived, do not write
-- your own instance!
class Typeable uni (a :: k) where
    -- | Get the Zerepoch IR type corresponding to this type.
...
-- | Class for types which can be lifted into Zerepoch IR. Instances should be derived, do not write your
-- own instance!
class Lift uni a where
    -- | Get a Zerepoch IR term corresponding to the given value.
