...
-- | Zerepoch Tx version of 'Data.Semigroup.Semigroup'.
class Semigroup a where
    -- | Zerepoch Tx version of '(Data.Semigroup.<>)'.
    (<>) :: a -> a -> a
