...
-- | Primitive names and functions for working with Zerepoch Core builtins.
module ZerepochTx.Builtins (
                                -- * Bytestring builtins
                                BuiltinByteString
                                , appendByteString
                                , consByteString
...
import           ZerepochTx.Builtins.Class
import           ZerepochTx.Builtins.Internal (BuiltinByteString (..), BuiltinData, BuiltinString)
