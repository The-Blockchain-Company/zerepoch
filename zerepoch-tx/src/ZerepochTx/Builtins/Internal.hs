...
-- in Zerepoch Core.
--
-- Most users should not use this module directly, but rather use 'ZerepochTx.Builtins'.
module ZerepochTx.Builtins.Internal where
...
-- | An opaque type representing Zerepoch Core ByteStrings.
...
{-|
A type corresponding to the Zerepoch Core builtin equivalent of 'PLC.Data'.
