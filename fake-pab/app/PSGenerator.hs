...
psContract =
    TypeInfo "web-common-simeon" "Simeon.Semantics" "Contract" <$>
    psTypeParameters
...
psState =
    TypeInfo "web-common-simeon" "Simeon.Semantics" "State" <$>
    psTypeParameters
...
psTransactionInput =
    TypeInfo "web-common-simeon" "Simeon.Semantics" "TransactionInput" <$>
    psTypeParameters
...
psTransactionWarning =
    TypeInfo "web-common-simeon" "Simeon.Semantics" "TransactionWarning" <$>
    psTypeParameters
