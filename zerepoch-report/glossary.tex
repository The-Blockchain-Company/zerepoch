...
\newglossaryentry{bcc}{
  name=bcc,
  description={
    The primary currency on the \gls{bcc} blockchain. Unlike other \glspl{currency}, bcc cannot be forged.
  }
}
\newglossaryentry{bcc}
{
  name=Bcc,
  description={A third-generation blockchain developed by The Blockchain Co..}
}
\newglossaryentry{klarity}
{
  name=Klarity,
  description={The primary wallet frontend developed by The Blockchain Co. for use with \gls{bcc}.}
}
\newglossaryentry{zerepoch-platform}
{
  name=Zerepoch Platform,
  description={
...
\newglossaryentry{slot-leader}
{
  name=slot leader,
  description={
    The servers adding new blocks to the chain in the proof-of-stake Shardagnostic protocol, corresponding to the miners of a proof-of-work protocol as employed in Bitcoin.
  }
}
...
\newglossaryentry{wallet-frontend}
{
  ...
  description={
    A graphical user interface to a wallet, typically backed by a \gls{wallet-backend}, e.g. \gls{klarity}.
  }
}
...
\newglossaryentry{eutxo-model}
{
  ...
  description={
    The ledger model which the \gls{zerepoch-platform} relies on.
    This is implemented in the Charles release of \gls{bcc}.
    See \cref{sec:eutxo}.
  }
}
...
\newglossaryentry{script}
{
  ...
  description={
    ...
    In the \gls{zerepoch-platform}, these are written in \gls{zerepoch-core}.
    See \cref{sec:eutxo}.
  }
}
...
\newglossaryentry{cost-model}
{
  name=cost-model,
  description={
    A set of parameters which affect how the \gls{zerepoch-core} evaluator costs a program evaluation.
...
\newglossaryentry{zerepoch-core}
{
  name=Zerepoch Core,
  description={
    The programming language used for \glspl{script} in the \gls{zerepoch-platform}.
    See \cref{sec:zerepoch-core}.
  }
}
...
\newglossaryentry{app}
{
  name=Zerepoch application,
  description={
    TODO: better name?
    An application built using the \gls{zerepoch-platform}.
  }
}
...
\newacronym[description={
  ...
  See \cref{sec:pab}.
}]{pab}{PAB}{Zerepoch Application Backend}
\newacronym[description={
  The overall framework for writing and running \glspl{app}.
  See \cref{sec:paf}.
}]{paf}{PAF}{Zerepoch Application Framework}
...
\newglossaryentry{zerepoch-ir}
{
  name=Zerepoch IR,
  description={
    An intermediate language that compiles to \gls{zerepoch-core}.
    See \cref{sec:zerepoch-ir}.
  }
}
\newglossaryentry{zerepoch-playground}
{
  name=Zerepoch Playground,
  description={
    A web based environment for trying out the \gls{zerepoch-platform}.
    See \cref{sec:zerepoch-playground}.
  }
}
\newglossaryentry{zerepoch-sdk}
{
  name=Zerepoch Haskell SDK,
  description={
    The libraries and development tooling for writing \glspl{app} in Haskell.
    See \cref{sec:sdk}.
  }
}
\newglossaryentry{zerepoch-tx}
{
  name=Zerepoch Tx,
  description={
    The libraries and compiler for compiling Haskell into \gls{zerepoch-core} to form the on-chain part of an \gls{app}.
    See \cref{sec:zerepoch-tx}.
  }
}
