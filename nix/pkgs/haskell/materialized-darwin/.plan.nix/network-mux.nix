{ system
  ...
  , ... }:
  {
    ...
    package = {
      ...
      maintainer = "duncan@well-typed.com, marcin.szamotulski@bcccoin.io, marc.fontaine@bcccoin.io, karl.knutsson@bcccoin.io, alex@well-typed.com, neil.davies@pnsol.com";
