{
  ...
  extras = hackage:
    {
      packages = {
        shardagnostic-network = ./.plan.nix/shardagnostic-network.nix;
        flat = ./.plan.nix/flat.nix;
        simeon = ./.plan.nix/simeon.nix;
        zerepoch-use-cases = ./.plan.nix/zerepoch-use-cases.nix;
        zerepoch-ghc-stub = ./.plan.nix/zerepoch-ghc-stub.nix;
        bcc-cli = ./.plan.nix/bcc-cli.nix;
        purescript-bridge = ./.plan.nix/purescript-bridge.nix;
        zerepoch-playground-server = ./.plan.nix/zerepoch-playground-server.nix;
        shardagnostic-consensus-bcc = ./.plan.nix/shardagnostic-consensus-bcc.nix;
        bcc-crypto-wrapper = ./.plan.nix/bcc-crypto-wrapper.nix;
        typed-protocols = ./.plan.nix/typed-protocols.nix;
        shardagnostic-network-testing = ./.plan.nix/shardagnostic-network-testing.nix;
        servant-purescript = ./.plan.nix/servant-purescript.nix;
        shardagnostic-consensus-sophie = ./.plan.nix/shardagnostic-consensus-sophie.nix;
        zerepoch-benchmark = ./.plan.nix/zerepoch-benchmark.nix;
        bcc-slotting = ./.plan.nix/bcc-slotting.nix;
        playground-common = ./.plan.nix/playground-common.nix;
        bcc-node = ./.plan.nix/bcc-node.nix;
        bcc-crypto-class = ./.plan.nix/bcc-crypto-class.nix;
        lobemo-backend-monitoring = ./.plan.nix/lobemo-backend-monitoring.nix;
        simeon-dashboard-server = ./.plan.nix/simeon-dashboard-server.nix;
        tracer-transformers = ./.plan.nix/tracer-transformers.nix;
        zerepoch-tx-plugin = ./.plan.nix/zerepoch-tx-plugin.nix;
        simeon-symbolic = ./.plan.nix/simeon-symbolic.nix;
        zerepoch-metatheory = ./.plan.nix/zerepoch-metatheory.nix;
        simeon-playground-server = ./.plan.nix/simeon-playground-server.nix;
        ...
        bcc-config = ./.plan.nix/bcc-config.nix;
        ...
        bcc-prelude-test = ./.plan.nix/bcc-prelude-test.nix;
        zerepoch-errors = ./.plan.nix/zerepoch-errors.nix;
        zerepoch-pab = ./.plan.nix/zerepoch-pab.nix;
        typed-protocols-examples = ./.plan.nix/typed-protocols-examples.nix;
        bcc-crypto-tests = ./.plan.nix/bcc-crypto-tests.nix;
        freer-extras = ./.plan.nix/freer-extras.nix;
        bcc-ledger-cole-test = ./.plan.nix/bcc-ledger-cole-test.nix;
        zerepoch-tx = ./.plan.nix/zerepoch-tx.nix;
        ...
        bcc-ledger-cole = ./.plan.nix/bcc-ledger-cole.nix;
        sophie-spec-ledger-test = ./.plan.nix/sophie-spec-ledger-test.nix;
        bcc-api = ./.plan.nix/bcc-api.nix;
        shardagnostic-consensus = ./.plan.nix/shardagnostic-consensus.nix;
        bcc-binary = ./.plan.nix/bcc-binary.nix;
        bcc-prelude = ./.plan.nix/bcc-prelude.nix;
        zerepoch-doc = ./.plan.nix/zerepoch-doc.nix;
        optparse-applicative-fork = ./.plan.nix/optparse-applicative-fork.nix;
        shardagnostic-network-framework = ./.plan.nix/shardagnostic-network-framework.nix;
        lobemo-backend-aggregation = ./.plan.nix/lobemo-backend-aggregation.nix;
        zerepoch-ledger-api = ./.plan.nix/zerepoch-ledger-api.nix;
        io-classes = ./.plan.nix/io-classes.nix;
        shardagnostic-consensus-cole = ./.plan.nix/shardagnostic-consensus-cole.nix;
        contra-tracer = ./.plan.nix/contra-tracer.nix;
        orphans-deriving-via = ./.plan.nix/orphans-deriving-via.nix;
        sophie-spec-non-integral = ./.plan.nix/sophie-spec-non-integral.nix;
        zerepoch-ledger = ./.plan.nix/zerepoch-ledger.nix;
        bcc-ledger-aurum = ./.plan.nix/bcc-ledger-aurum.nix;
        small-steps-test = ./.plan.nix/small-steps-test.nix;
        zerepoch-chain-index = ./.plan.nix/zerepoch-chain-index.nix;
        Win32-network = ./.plan.nix/Win32-network.nix;
        bcc-ledger-core = ./.plan.nix/bcc-ledger-core.nix;
        bcc-ledger-sophie-ma = ./.plan.nix/bcc-ledger-sophie-ma.nix;
        shepards = ./.plan.nix/shepards.nix;
        ...
        bcc-crypto = ./.plan.nix/bcc-crypto.nix;
        sophie-spec-ledger = ./.plan.nix/sophie-spec-ledger.nix;
        simeon-actus = ./.plan.nix/simeon-actus.nix;
  ...
  modules = [
    ({ lib, ... }:
      {
        packages = {
          ...
          "shardagnostic-network-testing" = { flags = {}; };
          "servant-purescript" = { flags = {}; };
          "shardagnostic-consensus-sophie" = {
            flags = { "asserts" = lib.mkOverride 900 false; };
            };
          "zerepoch-benchmark" = { flags = {}; };
          "bcc-slotting" = {
            flags = { "development" = lib.mkOverride 900 false; };
            };
          ...
          "simeon-dashboard-server" = { flags = {}; };
          "tracer-transformers" = { flags = {}; };
          "zerepoch-tx-plugin" = {
            flags = { "use-ghc-stub" = lib.mkOverride 900 false; };
            };
          "simeon-symbolic" = { flags = {}; };
          "zerepoch-metatheory" = { flags = {}; };
          "simeon-playground-server" = { flags = {}; };
          "measures" = {
            flags = { "development" = lib.mkOverride 900 false; };
            };
          ...
          "shardagnostic-network-framework" = { flags = {}; };
          "lobemo-backend-aggregation" = { flags = {}; };
          "zerepoch-ledger-api" = { flags = {}; };
          "io-classes" = {
            flags = {
          ...
          "bcc-ledger-aurum" = { flags = {}; };
          "small-steps-test" = {
            flags = { "development" = lib.mkOverride 900 false; };
            };
          "zerepoch-chain-index" = { flags = {}; };
          "Win32-network" = { flags = { "demo" = lib.mkOverride 900 false; }; };
          "bcc-ledger-core" = { flags = {}; };
          "bcc-ledger-sophie-ma" = { flags = {}; };
          "shepards" = {
            flags = { "development" = lib.mkOverride 900 false; };
            };
    ...
    ({ lib, ... }:
      {
        packages = {
          "zerepoch-doc".components.exes."doc-doctests".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-contract".components.library.planned = lib.mkOverride 900 true;
          "servant-options".components.library.planned = lib.mkOverride 900 true;
          "zerepoch-pab".components.tests."zerepoch-pab-test-light".planned = lib.mkOverride 900 true;
          ...
          "simeon-dashboard-server".components.tests."simeon-dashboard-server-test".planned = lib.mkOverride 900 true;
          "zerepoch-playground-server".components.tests."zerepoch-playground-server-test".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-chain-index".components.tests."zerepoch-chain-index-test".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-core".components.tests."zerepoch-ir-test".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-core".components.tests."zerepoch-core-test".planned = lib.mkOverride 900 true;
          ...
          "simeon-playground-server".components.tests."simeon-playground-server-test".planned = lib.mkOverride 900 true;
          ...
          "simeon".components.tests."simeon-test".planned = lib.mkOverride 900 true;
          "quickcheck-dynamic".components.tests."quickcheck-dynamic-test".planned = lib.mkOverride 900 true;
          "zerepoch-use-cases".components.tests."zerepoch-use-cases-test".planned = lib.mkOverride 900 true;
          "simeon-actus".components.exes."simeon-shiny".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-ledger".components.tests."zerepoch-ledger-test".planned = lib.mkOverride 900 true;
          ...
          "bcc-crypto".components.library.planned = lib.mkOverride 900 true;
          "shepards".components.library.planned = lib.mkOverride 900 true;
          ...
          "simeon-actus".components.library.planned = lib.mkOverride 900 true;
          ...
          "zerepoch-core".components.benchmarks."index-envs-bench".planned = lib.mkOverride 900 true;
          ...
          "bcc-ledger-sophie-ma".components.library.planned = lib.mkOverride 900 true;
          "shardagnostic-consensus-cole".components.exes."db-converter".planned = lib.mkOverride 900 true;
          "simeon-playground-server".components.exes."simeon-playground-server".planned = lib.mkOverride 900 true;
          "bcc-cli".components.exes."bcc-cli".planned = lib.mkOverride 900 true;
          "bcc-node".components.exes."bcc-node".planned = lib.mkOverride 900 true;
          "bcc-ledger-core".components.library.planned = lib.mkOverride 900 true;
          ...
          "sophie-spec-ledger".components.library.planned = lib.mkOverride 900 true;
          ...
          "zerepoch-playground-server".components.exes."zerepoch-playground-server".planned = lib.mkOverride 900 true;
          "zerepoch-core".components.benchmarks."cost-model-test".planned = lib.mkOverride 900 true;
          ...
          "simeon".components.tests."simeon-test-long-running".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-metatheory".components.exes."plc-agda".planned = lib.mkOverride 900 true;
          "zerepoch-errors".components.library.planned = lib.mkOverride 900 true;
          ...
          "bcc-prelude-test".components.library.planned = lib.mkOverride 900 true;
          "zerepoch-metatheory".components.tests."test1".planned = lib.mkOverride 900 true;
          "base64-bytestring".components.library.planned = lib.mkOverride 900 true;
          "bcc-binary-test".components.library.planned = lib.mkOverride 900 true;
          ...
          "zerepoch-pab".components.library.planned = lib.mkOverride 900 true;
          "zerepoch-core".components.library.planned = lib.mkOverride 900 true;
          ...
          "zerepoch-chain-index".components.library.planned = lib.mkOverride 900 true;
          ...
          "zerepoch-errors".components.exes."zerepoch-errors-next".planned = lib.mkOverride 900 true;
          ...
          "network-mux".components.exes."bcc-ping".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-tx-plugin".components.tests."zerepoch-tx-tests".planned = lib.mkOverride 900 true;
          ...
          "bcc-ledger-aurum".components.library.planned = lib.mkOverride 900 true;
          ...
          "sophie-spec-non-integral".components.library.planned = lib.mkOverride 900 true;
          ...
          "zerepoch-ledger".components.library.planned = lib.mkOverride 900 true;
          ...
          "zerepoch-use-cases".components.exes."zerepoch-use-cases-scripts".planned = lib.mkOverride 900 true;
          ...
          "shardagnostic-consensus-cole".components.library.planned = lib.mkOverride 900 true;
          ...
          "simeon-symbolic".components.library.planned = lib.mkOverride 900 true;
          "streaming-bytestring".components.library.planned = lib.mkOverride 900 true;
          "simeon-dashboard-server".components.library.planned = lib.mkOverride 900 true;
          ...
          "zerepoch-metatheory".components.setup.planned = lib.mkOverride 900 true;
          ...
          "zerepoch-tx-plugin".components.library.planned = lib.mkOverride 900 true;
          "tracer-transformers".components.library.planned = lib.mkOverride 900 true;
          "zerepoch-benchmark".components.benchmarks."nofib-hs".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-metatheory".components.library.planned = lib.mkOverride 900 true;
          ...
          "shardagnostic-network-framework".components.exes."demo-ping-pong".planned = lib.mkOverride 900 true;
          "zerepoch-pab".components.tests."zerepoch-pab-test-full".planned = lib.mkOverride 900 true;
          ...
          "bcc-api".components.library.planned = lib.mkOverride 900 true;
          "hspec-expectations".components.library.planned = lib.mkOverride 900 true;
          "bcc-ledger-cole".components.library.planned = lib.mkOverride 900 true;
          ...
          "sophie-spec-ledger-test".components.library.planned = lib.mkOverride 900 true;
          ...
          "bcc-crypto-test".components.library.planned = lib.mkOverride 900 true;
          ...
          "zerepoch-pab".components.exes."tx-inject".planned = lib.mkOverride 900 true;
          ...
          "bcc-crypto-wrapper".components.library.planned = lib.mkOverride 900 true;
          "ansi-terminal".components.library.planned = lib.mkOverride 900 true;
          "typed-protocols".components.library.planned = lib.mkOverride 900 true;
          "zerepoch-core".components.exes."pir".planned = lib.mkOverride 900 true;
          ...
          "bcc-api".components.sublibs."gen".planned = lib.mkOverride 900 true;
          "parsers".components.library.planned = lib.mkOverride 900 true;
          "base-compat".components.library.planned = lib.mkOverride 900 true;
          "zerepoch-pab".components.exes."sync-client".planned = lib.mkOverride 900 true;
          ...
          "simeon-playground-server".components.exes."flow-chart-generator".planned = lib.mkOverride 900 true;
          "zerepoch-pab".components.exes."zerepoch-pab-test-psgenerator".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-pab".components.exes."zerepoch-pab-examples".planned = lib.mkOverride 900 true;
          "shardagnostic-network-testing".components.library.planned = lib.mkOverride 900 true;
          ...
          "simeon".components.exes."simeon-pab".planned = lib.mkOverride 900 true;
          "cookie".components.library.planned = lib.mkOverride 900 true;
          "generic-data".components.library.planned = lib.mkOverride 900 true;
          "shardagnostic-network".components.exes."demo-chain-sync".planned = lib.mkOverride 900 true;
          "zerepoch-use-cases".components.library.planned = lib.mkOverride 900 true;
          "pipes".components.library.planned = lib.mkOverride 900 true;
          "shardagnostic-network".components.library.planned = lib.mkOverride 900 true;
          "zerepoch-contract".components.tests."zerepoch-contract-test".planned = lib.mkOverride 900 true;
          ...
          "shardagnostic-consensus-bcc".components.library.planned = lib.mkOverride 900 true;
          "zerepoch-core".components.tests."satint-test".planned = lib.mkOverride 900 true;
          "zerepoch-metatheory".components.tests."test3".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-tx".components.tests."zerepoch-tx-test".planned = lib.mkOverride 900 true;
          ...
          "simeon".components.library.planned = lib.mkOverride 900 true;
          ...
          "zerepoch-ghc-stub".components.library.planned = lib.mkOverride 900 true;
          ...
          "zerepoch-ledger-api".components.tests."zerepoch-ledger-api-test".planned = lib.mkOverride 900 true;
          "bcc-cli".components.library.planned = lib.mkOverride 900 true;
          "simeon-actus".components.tests."simeon-actus-test".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-core".components.tests."index-envs-test".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-benchmark".components.benchmarks."validation".planned = lib.mkOverride 900 true;
          "either".components.library.planned = lib.mkOverride 900 true;
          "ghc-paths".components.library.planned = lib.mkOverride 900 true;
          "zerepoch-playground-server".components.library.planned = lib.mkOverride 900 true;
          ...
          "zerepoch-benchmark".components.exes."nofib-exe".planned = lib.mkOverride 900 true;
          "bcc-crypto-tests".components.library.planned = lib.mkOverride 900 true;
          ...
          "zerepoch-chain-index".components.exes."zerepoch-chain-index".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-tx".components.library.planned = lib.mkOverride 900 true;
          ...
          "simeon-dashboard-server".components.exes."simeon-dashboard-server".planned = lib.mkOverride 900 true;
          ...
          "bcc-ledger-cole-test".components.library.planned = lib.mkOverride 900 true;
          ...
          "simeon-actus".components.exes."simeon-actus-test-kit".planned = lib.mkOverride 900 true;
          "text".components.library.planned = lib.mkOverride 900 true;
          "beam-core".components.library.planned = lib.mkOverride 900 true;
          "zerepoch-benchmark".components.tests."zerepoch-benchmark-nofib-tests".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-core".components.tests."untyped-zerepoch-core-test".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-core".components.exes."uplc".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-core".components.benchmarks."update-cost-model".planned = lib.mkOverride 900 true;
          "mtl".components.library.planned = lib.mkOverride 900 true;
          "zerepoch-errors".components.exes."zerepoch-errors-bootstrap".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-playground-server".components.sublibs."zerepoch-playground-usecases".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-pab".components.exes."zerepoch-pab-setup".planned = lib.mkOverride 900 true;
          ...
          "simeon-playground-server".components.library.planned = lib.mkOverride 900 true;
          ...
          "bcc-config".components.library.planned = lib.mkOverride 900 true;
          ...
          "zerepoch-metatheory".components.tests."test2".planned = lib.mkOverride 900 true;
          "websockets".components.library.planned = lib.mkOverride 900 true;
          "zerepoch-core".components.benchmarks."cost-model-budgeting-bench".planned = lib.mkOverride 900 true;
          ...
          "bcc-prelude".components.library.planned = lib.mkOverride 900 true;
          "shardagnostic-consensus".components.library.planned = lib.mkOverride 900 true;
          ...
          "zerepoch-ledger-api".components.library.planned = lib.mkOverride 900 true;
          "turtle".components.library.planned = lib.mkOverride 900 true;
          "bcc-binary".components.library.planned = lib.mkOverride 900 true;
          "uniplate".components.library.planned = lib.mkOverride 900 true;
          "parsec".components.library.planned = lib.mkOverride 900 true;
          "ghc-boot-th".components.library.planned = lib.mkOverride 900 true;
          "shardagnostic-network-framework".components.library.planned = lib.mkOverride 900 true;
          ...
          "zerepoch-pab".components.exes."zerepoch-uniswap".planned = lib.mkOverride 900 true;
          ...
          "shardagnostic-network".components.sublibs."shardagnostic-protocol-tests".planned = lib.mkOverride 900 true;
          ...
          "shardagnostic-consensus-bcc".components.exes."db-analyser".planned = lib.mkOverride 900 true;
          "bcc-slotting".components.library.planned = lib.mkOverride 900 true;
          "bsb-http-chunked".components.library.planned = lib.mkOverride 900 true;
          "primitive".components.library.planned = lib.mkOverride 900 true;
          "shardagnostic-consensus-sophie".components.library.planned = lib.mkOverride 900 true;
          "zerepoch-core".components.sublibs."index-envs".planned = lib.mkOverride 900 true;
          ...
          "zerepoch-benchmark".components.library.planned = lib.mkOverride 900 true;
          "bcc-node".components.library.planned = lib.mkOverride 900 true;
          ...
          "bcc-crypto-class".components.library.planned = lib.mkOverride 900 true;
          };
        })
    ];
  }