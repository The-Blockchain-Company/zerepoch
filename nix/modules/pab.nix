...
in
{
  options.services.pab = {
    ...
    slotZeroTime = mkOption {
      type = types.int;
      default = 1596059091000; # POSIX time of 2020-07-29T21:44:51Z (Wednesday, July 29, 2020 21:44:51) - Sophie launch time
      description = ''
    ...
    constantFee = mkOption {
      ...
      default = 10;
      description = ''
        Constant fee per transaction in entropic.
      '';
    };
    ...
    scriptsFeeFactor = mkOption {
      ...
      default = 1.0;
      description = ''
        Factor by which to multiply the size-dependent scripts fee in entropic.
      '';
    };
