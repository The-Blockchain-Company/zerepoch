...
import           Zerepoch.Trace.Emulator.Types       (ContractInstanceLog, EmulatedWalletEffects, EmulatedWalletEffects',
                                                    UserThreadMsg)
import qualified Zerepoch.Trace.Scheduler            as Scheduler
...
Zerepoch contracts interact with the outside world through a number of different
...
because it would make the emulated wallet effects unrealistic - Zerepoch
