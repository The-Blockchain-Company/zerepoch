...
module Zerepoch.Contract.StateMachine.OnChain(
      StateMachine(..)
...
import           ZerepochTx.Prelude                         hiding (check)
import qualified Prelude                                  as Haskell

import qualified Zerepoch.Contract.StateMachine.ThreadToken as TT
...
mkValidator :: forall s i. (ZerepochTx.ToData s) => StateMachine s i -> ValidatorType (StateMachine s i)
