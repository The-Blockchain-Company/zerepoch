...
module Zerepoch.Contract.Trace.RequestHandler(
    RequestHandler(..)
...
import qualified Zerepoch.ChainIndex.Effects      as ChainIndexEff
import           Zerepoch.Contract.Effects        (ChainIndexQuery (..), ChainIndexResponse (..))
import qualified Zerepoch.Contract.Wallet         as Wallet
