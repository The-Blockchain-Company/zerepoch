...
-}
module Zerepoch.Trace.Scheduler(
    ThreadId
    , SysCall
    , MessageCall(..)
    , ThreadCall(..)
...
time. See note [Simulator Time] in 'Zerepoch.Trace.Emulator.System' for details.
...
constructor of 'Zerepoch.Trace.Emulator.Types.EmulatorMessage'.)
